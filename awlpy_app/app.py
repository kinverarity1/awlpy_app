...
class AWLPyMainWindow(QMainWindow):
    def __init__(self):
        super(AWLPyMainWindow, self).__init__()
    ...
    def closeEvent(self, event):
        ...
        super(AWLPyMainWindow, self).closeEvent(event)
    ...
    def load_sonic_log_file(self, filename):
        ...
        self.tab_widget.addTab(log, log.name)
